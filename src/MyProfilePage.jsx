...
const MyProfilePage = ({ loggedInUser, isLeader, myMessages, userId, emailVerified }) => {
  ...
  return (
    <div>
      <div>
        <Header myProfile loggedInUser={loggedInUser} isLeader={isLeader} myMessages={myMessages} userId={userId} emailVerified={emailVerified}/>
